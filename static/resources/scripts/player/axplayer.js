...
(function () {
    ...
    function appendOutOfDateNotification() {
        ...
        if (!MOBILE_DEVICE) {
            toAppend += '       <div style="margin-right: 36px"><a href="{% static "http://outdatedbrowser.com/en" %}" id="updateBrowserButton">UPDATE BROWSER</a></div>';
    ...
    function initializeLogo() {
        ...
        //    $('#interfaceControlFrameLogoImageContainer').html('<img id="logoImage" src="/static/" />');
    ...
    */
    function buildAccountLoginPopup() {
        return [
            ...
            '           <span>No account? <a class="axureSignUpLink" href="{% static "', window.AXSHARE_HOST_SECURE_URL, '" %}" target="_blank">Sign Up</a></span>',
            '       </div>',
            '   </div>',
            '</div>'
        ].join("");
